...
import com.zy.domain.TableProcessDim;
...
public class DwdProcessFunction extends BroadcastProcessFunction<JSONObject,JSONObject,JSONObject>{
    ...
    public DwdProcessFunction(MapStateDescriptor<String, JSONObject> mapStageDesc) {
...
//        System.out.println(jsonObject.getJSONObject("after"));
...
//                System.err.println(jsonObject);
                if (!jsonObject.getString("op").equals("d")){
                    ...
                    if(configMap.containsKey(tableName)){
                        String op = kafkaData.getString("operation");
                        String tableName1 = kafkaData.getString("tableName");
                        String a=op +"_"+tableName1;
                        JSONObject data = kafkaData.getJSONObject("data");
                        list.add(data);
                        KafkaUtils.sinkJson2KafkaMessage(a,list);
                    }
